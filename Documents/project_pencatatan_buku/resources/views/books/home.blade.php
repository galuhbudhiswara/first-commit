...
@section('container')
    ...
    <div class="jumbotron">
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text">Web CRUD Laravel Untuk Mencatat Informasi Buku</p>
                        ...
                        @foreach (isset($books) ? $books : [] as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('/books/' . $item->id) }}" class="btn btn-dark badge rounded-pill"
                                        style="width: 80px; height: 25px;">VIEW</a>
                                    <a href="{{ url('/books/' . $item->id . '/edit') }}"
                                        class="btn btn-dark badge rounded-pill"
